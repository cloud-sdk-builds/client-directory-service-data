...
[`@aws-sdk/client-directory-service-data`](https://www.npmjs.com/package/@aws-sdk/client-directory-service-data/v/3.1062.0).
...
- @aws-sdk/client-directory-service-data - [https://cloud-sdk-builds.github.io/?sdk=client-directory-service-data](https://cloud-sdk-builds.github.io/?sdk=client-directory-service-data)
- @aws-sdk/client-directory-service-data v3.1062.0 - [https://cloud-sdk-builds.github.io/?sdk=client-directory-service-data&version=3.1062.0](https://cloud-sdk-builds.github.io/?sdk=client-directory-service-data&version=3.1062.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-directory-service-data@3.1062.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FRr7OfkurBrrp2re4AtTNgprM2SkoJBhm8avRC8tJBLh5nHqjThkz0KcwIYaiGYY
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-directory-service-data/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-directory-service-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-directory-service-data@3.1062.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-directory-service-data@3.1062.0/index.min.mjs": "sha384-FRr7OfkurBrrp2re4AtTNgprM2SkoJBhm8avRC8tJBLh5nHqjThkz0KcwIYaiGYY"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-directory-service-data";
...
```
https://github.com/cloud-sdk-builds/client-directory-service-data/blob/refs/tags/3.1062.0/LICENSE
```
