...
[`@aws-sdk/client-directory-service-data`](https://www.npmjs.com/package/@aws-sdk/client-directory-service-data/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-directory-service-data@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-dJ6MVB75lDrG6sNZXcHidcff+349Rz5+pnqwa/FEZjoItdMDVqIl/berjLb+iqnK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-directory-service-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-directory-service-data@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-directory-service-data@3.677.0/index.min.mjs": "sha384-dJ6MVB75lDrG6sNZXcHidcff+349Rz5+pnqwa/FEZjoItdMDVqIl/berjLb+iqnK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-directory-service-data/blob/refs/tags/3.677.0/LICENSE
```
